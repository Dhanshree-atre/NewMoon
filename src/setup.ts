// Orchestrator for `npm run setup`. Brings up the services this network needs,
// compiles the contract, and deploys — branching on --network and forwarding
// it to deploy.
...
async function main(): Promise<void> {
  ...
  process.stdout.write(`\n→ Setting up private-airdrop on network: ${network}\n\n`);
