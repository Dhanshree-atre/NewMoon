// Print the preview wallet address (and, if present, its recovery phrase).
// Usage: npx tsx scripts/preview-address.ts
...
console.log(`Preview wallet address: ${keystore.getBech32Address().toString()}`);
